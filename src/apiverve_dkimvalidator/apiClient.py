...
class DkimvalidatorAPIClient:
    def __init__(self, api_key, secure=True):
        """
        Initialize the DkimvalidatorAPIClient with the API key and secure flag
        ...
        self.secure = secure
        self.base_url = 'https://api.apiverve.com/v1/dkimvalidator'
        self.headers = {
